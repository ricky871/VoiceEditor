...
class UnifiedVoice(nn.Module):
    ...
    def inference_speech(self, speech_condition, text_inputs, emo_speech_condition=None, cond_lengths=None, emo_cond_lengths=None, emo_vec=None, use_speed=False, input_tokens=None, num_return_sequences=1,
        ...
        """
        # SAFEGUARD: Remove model-incompatible parameters that might leak from higher levels
        hf_generate_kwargs.pop("diffusion_steps", None)
        hf_generate_kwargs.pop("spk_audio_prompt", None)
        hf_generate_kwargs.pop("emo_audio_prompt", None)
        hf_generate_kwargs.pop("emo_alpha", None)
        hf_generate_kwargs.pop("verbose", None)
        hf_generate_kwargs.pop("use_emo_text", None)
        hf_generate_kwargs.pop("emo_text", None)
        hf_generate_kwargs.pop("emo_vector", None)
